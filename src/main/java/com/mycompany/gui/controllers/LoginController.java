...
public class LoginController {
    ...
    private void cambiarPantalla(Usuario usuario) {
        String fxmlFile = switch (usuario.getRol()) {
            case "admin" ->
                "/com/mycompany/views/Admin.fxml";
            case "registrado" ->
                "/com/mycompany/views/Registered.fxml";
            case "invitado" ->
                "/com/mycompany/views/Guest.fxml";
            default ->
                null;
        };
        ...
        if (fxmlFile != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource(fxmlFile.substring(1)));
